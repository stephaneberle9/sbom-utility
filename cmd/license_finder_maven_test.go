...
func innerTestIsApplicableToMavenComponent(t *testing.T, purl string, expectedResult bool) {
	...
	result, err := MavenComponentLicenseFinder.IsApplicable(cdxComponent)
	if err != nil {
...
func innerTestFindLicenseOfMavenComponent(t *testing.T, group string, name string, version string, expectedLicense string, expectedLicenseUrl string) {
	innerTestFindLicensesOfMavenComponent(t, group, name, version, []string{expectedLicense}, []string{expectedLicenseUrl})
}

func innerTestFindLicensesOfMavenComponent(t *testing.T, group string, name string, version string, expectedLicenses []string, expectedLicenseUrls []string) {
	...
	licenseChoices, err := MavenComponentLicenseFinder.FindLicenses(cdxComponent)
	if err != nil {
...
func TestIsApplicableToMavenComponent(t *testing.T) {
